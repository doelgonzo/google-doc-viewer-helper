...
describe('generator utils', () => {
  ...
  it('can generate valid google doc urls using a viewer override', () => {
    expect(generators.generateGoogleDocUrlWithParams(params, 'gview')).to.equal(validGoogleDocUrlWithGView);
  });

  it('should fall back to default viewer if specified viewer does not exist', () => {
  ...
  it('should warn the user passing params that will overwrite default embedding params (triggera two console warnings)', () => {
    console.warn = noopFn;
